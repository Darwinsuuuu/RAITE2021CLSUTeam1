                ...
                <nav class="navbar navbar-expand-lg navbar-light ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white  my-active" href="#contracts.php"><i class="bi bi-file-earmark-text"></i> Contracts</a>
                            </li>
                        </ul>
                ...
                <div class="container mt-5">
                    <div class="row mb-3">
                        ...
                        <div class="col text-end">
                            <!-- add button -->
                            <button class="btn bg-seaferer text-white"><i class="bi bi-plus-square-dotted"></i> Add Contract</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
